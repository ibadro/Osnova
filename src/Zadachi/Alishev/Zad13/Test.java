...
public class Test {
    public static void main(String[] args) {
        ...
        user.sendMessage(user2,  "Hello");
        user.sendMessage(user2,  "Hello. alsdk;lfkas;d'lkf;'lk");

        user2.sendMessage(user,"Hello");
        user2.sendMessage(user,"Hello.asdasdas");
        user2.sendMessage(user,"Hello.asdasdasasdf;lkasd;lkf'la;skdf;lkasd;flkas'dl;kf;l");

        user3.sendMessage(user,"Hello");

        user.sendMessage(user3,"alkdjsflkajsd;lfkjas;lkdfj");
        user.sendMessage(user3,"alkdjsflkajsd;lfkjas;lkdfj");
...
/**День 13
 ...
 пользователь подписан на пользователя ​ user​и ​ False​ , если не подписан.- public boolean isFriend(User user)​- возвращает ​ True​ , если
 ...
 *в поле ​ ON​должна быть дата создания объекта класса ​ Message
 ...
 данных”, которая хранит все сообщения в соц. сети.Конструктор:
